...
class JobLocation extends React.Component<Props, State> {
  ...
  handleChange = (event: any, { newValue }: ChangeEvent) => {
    ...
    const selectedItem = this.props.locations.find(item => item.label === newValue) || null
...
export default withStyles(styles)(JobLocation)
